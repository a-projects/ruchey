...
В языковых параметрах удалить раскладку Русская (ЙЦУКЕН)

![изображение](https://user-images.githubusercontent.com/38563625/154339822-f755f870-c9b4-4749-a2d1-0d4cbeaacfbb.png)

В предпочитаемых языках удалить Английский

![изображение](https://user-images.githubusercontent.com/38563625/154339684-c446fe95-84e6-4298-b47a-f703e9dba50e.png)
...
### Linux
В Linux приходится затрагивать системные файлы, которые будут перезаписаны при обновлении соответствующего пакета (XKB). Поэтому разработан пакет (Debian/Ubuntu) с хуком, который патчит эти системные файлы после обновления системы. Раскладка версии 1.1.0 будет доступна во всех дистрибутивах из коробки, начиная с пакета xkeyboard-config-2.35.
